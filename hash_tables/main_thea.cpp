...
void test1(){
    ...
    auto el1 = tab.buscar(44);
    if(el1 == tab.invalido){
        std::cout << "Chave 44 nao encontrada" << std::endl;
    } else {
        std::cout << "Chave 44 encontrada" << std::endl;
    }

    auto el2 = tab.buscar(43);
    if(el2 == tab.invalido){
        std::cout << "Chave 43 nao encontrada" << std::endl;
    } else {
        std::cout << "Chave 43 encontrada, valor: " << el2.second << std::endl;
    }
